...
| Item | Location |
|------|----------|
| DO Prod App ID | `REDACTED-DO-PROD-APP-ID` (`~/.grok/secrets/matchforge-do-deployment.env`) |
| DO Stage App ID | `REDACTED-DO-STAGE-APP-ID` (`~/.grok/secrets/matchforge-dev-deployment.env`) |
